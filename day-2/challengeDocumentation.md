# Application Deployment Using a Bach Script
This Markdown file provides information on deployment a bash script on an AWS EC2 Instance.

## Prerequisites / App Dependencies
...
![alt text](images/nginx_homepage.png)
---
...
3. Use the SCP command to transfer files to your EC2 instance
    ...
    `scp -i ~/.ssh/se-dare-key-pair.pem ./nodejs20-se-test-app-2025.zip ubuntu@<your-ec2-public-dns>:/home/ubuntu/` 
...
> NB. `npm start <example.js>` can be run with a relative filepath
...
![alt text](imgages/delete_instance.png)